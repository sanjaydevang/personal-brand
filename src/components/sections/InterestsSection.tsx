    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="md:hidden -mx-4 px-4">
          <div className="overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-[#7EA046]/20 scrollbar-track-transparent">
            <div className="flex gap-5 min-w-max">
              {interests.map((interest, index) => (
                <motion.div
                  ...
                  className="group relative w-[300px] aspect-[3/4] overflow-hidden rounded-lg flex-shrink-0"
                >
                  {/* Background Image */}
